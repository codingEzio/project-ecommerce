package com.elliot.mall.demo.controller;
...
public class RestTemplateDemoController {
	...
	public Object getForEntity3(@PathVariable Long id) {
		...
		ResponseEntity<CommonResult> responseEntity = restTemplate.getForEntity(uriComponents.toUri(),
				CommonResult.class);
		return responseEntity.getBody();
	}
	...
	public Object postForEntity3(@RequestParam String name) {
		...
		ResponseEntity<CommonResult> responseEntity = restTemplate.postForEntity(url, requestEntity,
				CommonResult.class);
		return responseEntity.getBody();
	}
}

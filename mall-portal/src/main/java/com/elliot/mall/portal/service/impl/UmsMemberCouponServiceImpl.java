...
import com.elliot.mall.mapper.SmsCouponMapper;
import com.elliot.mall.mapper.SmsCouponProductCategoryRelationMapper;
import com.elliot.mall.mapper.SmsCouponProductRelationMapper;
import com.elliot.mall.model.PmsProduct;
import com.elliot.mall.model.SmsCoupon;
import com.elliot.mall.model.SmsCouponExample;
...
import com.elliot.mall.model.SmsCouponProductCategoryRelationExample;
import com.elliot.mall.model.SmsCouponProductRelation;
import com.elliot.mall.model.SmsCouponProductRelationExample;
import com.elliot.mall.model.UmsMember;
import org.springframework.beans.factory.annotation.Autowired;
import org.springframework.stereotype.Service;

import com.elliot.mall.common.exception.Asserts;
import com.elliot.mall.portal.dao.SmsCouponHistoryDao;
import com.elliot.mall.portal.domain.CartPromotionItem;
import com.elliot.mall.portal.domain.SmsCouponHistoryDetail;
import com.elliot.mall.portal.service.UmsMemberCouponService;
...
public class UmsMemberCouponServiceImpl implements UmsMemberCouponService {
	...
	public List<SmsCoupon> listByProduct(Long productId) {
		...
		if (CollUtil.isNotEmpty(cprList)) {
			List<Long> couponIds = cprList.stream().map(SmsCouponProductRelation::getCouponId)
		...
		List<SmsCouponProductCategoryRelation> cpcrList = couponProductCategoryRelationMapper
				.selectByExample(cpcrExample);
		if (CollUtil.isNotEmpty(cpcrList)) {
			List<Long> couponIds = cpcrList.stream().map(SmsCouponProductCategoryRelation::getCouponId)
					.collect(Collectors.toList());
			allCouponIds.addAll(couponIds);
		}
		// 所有优惠券
